...
export default function Privacy() {
  ...
  return (
    <div className="page page--centered gradient-love" style={{ padding: '2rem 1.5rem' }}>
      <div style={{ maxWidth: '560px', width: '100%', background: 'rgba(255,255,255,0.92)', borderRadius: '16px', padding: '2.5rem', margin: '0 auto' }}>
        ...
        <p style={{ color: '#333', lineHeight: 1.7, marginBottom: '1.25rem' }}>
          Letters created on Love or Lies are stored locally on your device. No one — including us — can read your letters. Only the person you share the letter code or link with can open it.
        </p>
        <p style={{ color: '#333', lineHeight: 1.7, marginBottom: '1.25rem' }}>
