...
export default function Home() {
  ...
  return (
    <div className="page page--centered gradient-love page--main-homepage">
      ...
      <BlurImage src="/assets/illos/heart-red.svg" alt="" className="heart heart--6 flip-h heart--animate" />
      ...
      <div className="content">
        ...
        <BlurImage className="lovestruck-title-img" src="../../public/assets/illos/love-struck-again-title.png" alt="" loading="lazy"/>
